import { version, defineComponent, provide, shallowReactive, h, ref, inject, watch, Suspense, nextTick, Fragment, Transition, useSSRContext, withCtx, createTextVNode, createApp, effectScope, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, resolveComponent, isRef, isShallow, isReactive, toRaw, computed } from 'vue';
...
import { h as createError$1, l as createHooks, t as toRouteMatcher, m as createRouter$1, n as sanitizeStatusCode } from '../runtime.mjs';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-BB_63DG5.mjs');
...
const unhead_aKGqBBdFqL = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "indev",
    path: "/indev",
    component: () => import('./indev-MndmXgUu.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BjgQMdzn.mjs')
  }
];
...
const revive_payload_server_Xvkr7OiMj4 = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_aKGqBBdFqL,
  plugin,
  revive_payload_server_Xvkr7OiMj4,
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><h1>ошибка</h1>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.7.5_eslint@9.12.0_jiti@2.3.3__ioredis@5.4.1__ryrqd4dfhjlkdyzkxarqapnn3y/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { On as O, _export_sfc as _, br as b, createError as c, entry$1 as default };
